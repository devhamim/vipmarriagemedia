...
<div class="jnews-wrap wrap about-wrap">
    ...
    ?>
        <div class="about-text">
            <?php
                esc_html_e( 'Please activate the license of JNews theme to get automatic theme update, official support service and all benefits from JNews. Read below for additional information.', 'jnews' );
            ?>
        </div>
        ...
        <div class="jnews-registration-wrap jnews-panel">
            <form method="POST" action="<?php menu_page_url($menu['dashboard']); ?>">
                ...
                <div class="input-token">
                    <input name="envato_token" class="large-text" autocomplete="off" type="text" placeholder="<?php esc_attr_e('Enter your Envato Token', 'jnews'); ?>" value="plugintheme">
        ...
        <div class="jnews-howto">
            ...
            <ol>
                ...
                <li><?php esc_html_e('Submit your token name, then check box the list as follows:', 'jnews') ?>
                    <ul>
                        <li><?php esc_html_e('View Your Envato Account Username', 'jnews') ?></li>
                        <li><?php esc_html_e('Download Your Purchased Items', 'jnews') ?></li>
                        <li><?php esc_html_e('Verify Purchases You’ve Made', 'jnews') ?></li>
                        <li><?php esc_html_e('List Purchases You’ve Made', 'jnews') ?></li>
                    </ul>
                </li>
                <li style="list-style-type: none;"><?php esc_html_e('Those lists need to be checked to grant permission needed for theme activation. The next step is to checkbox "Agree to the terms and conditions", and lastly click on the "Create Token" button to generate your token necessary for the theme activation.', 'jnews') ?></li>
                <li value="3"><?php esc_html_e('A new page will load with a token number in a box. Copy the token number then come back to this registration page and paste it into the field below and click the Submit button.','jnews'); ?></li>
                ...
                <li><?php esc_html_e('If the instructions above have been followed and the License created unable to register the product, try to reduce the token name to a maximum of 5 characters.','jnews'); ?></li>
            </ol>
        </div>
