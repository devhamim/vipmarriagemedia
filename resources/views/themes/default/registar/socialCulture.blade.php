...
@endpush
@section('content')
<div style="background-color: #f9ea8f; background-image: linear-gradient(315deg, #f9ea8f 0%, #aff1da 74%); padding: 50px 0;">
    <div class="row text-center">
        <div class="col-md-12 text-center">
            ...
            <form action="{{ route('socialCulture', $me->id) }}" role="form" method="POST"
                ...
                @csrf
                <div class="col-md-12 text-center">
                    <h2 class="my-3" style="font-weight: 600;">Social, Culture Background and Interests</h2>
